    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (cbxSport.Text == "Football")
            {
                ...
                txtCoachSalary.Text = Convert.ToString(aFootballTeam.CoachSalary()); //implementing interface
                txtEquipmentFees.Text = Convert.ToString(aFootballTeam.EquipmentFees()); //implementing interface
            ...
            else if (cbxSport.Text == "Soccer")
            {
                ...
                txtCoachSalary.Text = Convert.ToString(aSoccerTeam.CoachSalary()); //implementing interface
                txtEquipmentFees.Text = Convert.ToString(aSoccerTeam.EquipmentFees()); //implementing interface
